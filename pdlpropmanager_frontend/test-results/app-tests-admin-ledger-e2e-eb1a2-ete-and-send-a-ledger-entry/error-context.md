...
- Name: Admin can add, edit, delete, and send a ledger entry
- Location: C:\Users\plabr\PDL_APP\v2\frontend\pdlpropmanager_frontend\src\app\tests\admin-ledger-e2e.spec.js:14:7
...
Call log:
  - waiting for locator('text=accountledgers')

    at C:\Users\plabr\PDL_APP\v2\frontend\pdlpropmanager_frontend\src\app\tests\admin-ledger-e2e.spec.js:16:16
```
